...
<div style="position: absolute;top: 150px;left: 0px;width: 1368px;height: 50px;background-color: #14E288;">
	<table  width="1368px" height=50px class="mydes">
		<tr align="center"style="font-family:  Helvetica;font-weight: bold;">
			<td><div onclick="show('fxyz/utimeline.php')">Timeline</div></td>
			<td><div onclick="show('fxyz/uattendance.php')">Attendence</div></td>
			<td><div onclick="show('fxyz/uresult.php')">Result</div></td>
			<td><div onclick="show('fxyz/umatirial.php')">Material</div></td>
